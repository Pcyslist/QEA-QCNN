...
def generate_data(data_type, qubits):
    if data_type == "CIFAR10" :
        return generate_CIFAR10_data(qubits)
    if data_type == "MNIST" :
        return generate_mnist_data(qubits)
    if data_type == "Fashion-MNIST":
        return generate_fashion_mnist_data(qubits)

def generate_mnist_data(qubits):
    # 加载MNIST数据集
...
def generate_fashion_mnist_data(qubits):
    # 加载Fashion-MNIST数据集
...
def generate_CIFAR10_data(qubits):
