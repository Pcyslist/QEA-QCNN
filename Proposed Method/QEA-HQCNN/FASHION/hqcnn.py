...
train_excitations, train_labels, test_excitations, test_labels = dataset.generate_fashion_mnist_data(cluster_state_bits)
...
def train_qcnn():
    ...
    plt.title('Fashion-MNIST QEA-HQCNN Training')
    plt.xlabel('Epochs')
    plt.ylabel('Accuracy')
    plt.legend()
